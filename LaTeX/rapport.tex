...
Le tableau est divisé en 3 sous-tableaux de taille \texttt{LARGEUR*HAUTEUR}. On stocke les entiers par blocs de 16, donc pour un sous-tableau, on fera donc $\displaystyle{\frac{\texttt{LARGEUR} \times \texttt{HAUTEUR}}{16}}$ accès hors-caches.\\
...
À chaque accès hors-cache, on charge donc $8 \times 16 = 128$ entiers en cache.
Si $\texttt{LARGEUR} = \texttt{HAUTEUR} = 1024$, on fera $\frac{1024\times 1024}{128} = 8192$ accès hors-cache.\\

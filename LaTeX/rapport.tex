...
\subsection{Exercice 4}
On donne ci-dessous les deux codes obtenus:\\
...
Première différence : au niveau O2, on utilise plutôt des instructions comme \texttt{xor rax, rax} pour remplacer les instructions \texttt{mov rax, 0} qui sont plus rapides et prennent moins de place en mémoire.\\

Deuxième différence : le niveau O2 déplace des instructions afin de réduire les bulles.
Par exemple, la ligne 11 du code O2 correspond à la ligne 27 du code O1.\\

% Après exo 4, aller sur wikichip et étudier la description du pipeline de l'architecture skylake.

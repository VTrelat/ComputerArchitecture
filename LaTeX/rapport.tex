...
Or, le nombre de sous-cache ici est aussi une puissance de 2 -- mais beaucoup plus petite, d'où le $2^{20}$ -- donc à chaque accès au milieu du tableau tombe sur une puissance de 2.
